...
class _ScanScreenState extends State<ScanScreen> with WidgetsBindingObserver {
  ...
  Future<void> _processImage(File file) async {
    try {
      ...
      // NOTE:
      // The "save pin to map" feature was removed here because it required:
      // - google_maps_flutter (LatLng)
      // - ScanLocationStore / ScanPin (missing in project)
      // We'll re-add it later when those are implemented.
